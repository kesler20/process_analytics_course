...
phibatch.monitor(mpca_obj, bdata_aligned_phase)
...
pp.r2pv(mpls_obj) #just showing how it looks with this view
phibatch.monitor(mpls_obj, bdata_aligned_phase,zinit=initial_chem)
